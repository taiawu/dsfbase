...
Draft work for the development of the Shiny App used to interactively update subset labels
...
############ Repeated re-assignment three times (for completeness). 
 Because the app keeps track of what data you've reviewed, and only shows you data you haven't,
 I repeated assignments by manually overwriting the "reviewed" column here: 

Read in the completely re-assigned data
...
# in the app, load this directory. 
# after the first re-assignments, read the interactively updated directory to go through the rest of the entries (set in the app)
```
