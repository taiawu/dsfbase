...
umap_200 <- read_rds("../../git_ignore_data_outputs/04_UMAP_analysis/parameter_exploration/rfu/results/dsfbase_umap_juice_neighbors_200_mindist_0.2.rds") %>%
  select(-c("protein", "subset")) %>% 
  left_join(id_annotations, by = join_by("id"))

write_rds(x = umap_200, 
          "../../git_ignore_data_outputs/04_UMAP_analysis/final_parameters/dsfbase_UMAP_nn200_md0p2.rds")

umap_200 <- read_rds("../../git_ignore_data_outputs/04_UMAP_analysis/final_parameters/dsfbase_UMAP_nn200_md0p2.rds")
```

```{r}
umap_200$protein |> n_distinct()
```
...
plot_UMAP_by_protein(umap_200, 
                     ...
                     .save_to = "../../git_ignore_data_outputs/04_UMAP_analysis/final_parameters/plots/by_protein/")
...
============ Raw data for different parts of the UMAP
```{r}
dsfbase <- read_rds("/Users/taiaseanwu/Desktop/programming/dsfbase/__final_files_for_submission/dsfbase/dsfbase_v001_normalized_6165_entries.csv")
```
